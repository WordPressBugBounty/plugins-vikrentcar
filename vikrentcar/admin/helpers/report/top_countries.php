...
class VikRentCarReportTopCountries extends VikRentCarReport
{
	...
	public function getReportData()
	{
		...
		$this->cols = array(
			...
			array(
				'key' => 'country',
				'sortable' => 1,
				'label' => JText::translate('VRCREPORTTOPCOUNTRIESC')
			),
			//cars sold
			array(
				'key' => 'cars_sold',
			...
			array(
				...
				'sortable' => 1,
				'label' => JText::translate('VRCREPORTOPTIONSEXTRAS'),
				'tip' => JText::translate('VRCREPORTOPTIONSEXTRASHELP')
			),
			//Taxes
			array(
				'key' => 'taxes',
	...
	private function getCountriesMap($countries)
	{
		...
		if (in_array('unknown', $countries)) {
			$map['unknown'] = JText::translate('VRCREPORTTOPCUNKNC');
