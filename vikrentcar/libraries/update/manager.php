...
class VikRentCarUpdateManager
{
	 ...
	 * 
	 * @since 	1.4.0 	 The visibility of the method changed from protected to public.
	 * 					 Added support to the directory "pdfs" for contracts.
	 */
	public static function getUploadBackupDirs($real_paths = false)
	{
		if ($real_paths) {
			...
			return array(
				...
				// upload dir path for the contracts in PDF format
				'pdfs' 		=> VRC_SITE_PATH . DIRECTORY_SEPARATOR . 'resources' . DIRECTORY_SEPARATOR . 'pdfs',
		...
		return array(
			...
			// upload dir path for the contracts in PDF format
			'pdfs' 		=> $upload_dir['basedir'] . DIRECTORY_SEPARATOR . 'vikrentcar' . DIRECTORY_SEPARATOR . 'pdfs',
			// upload dir path for the scans of the ID/Documents of the customers
