	...
	public function translate($string)
	{
		...
		switch ($string)
		{
			...
			case 'VRC_LOCATION_BREAK_FROM_TO':
				...
				break;
			case 'VRCCHOOSEDEPOSIT':
				$result = __('Payment Terms', 'vikrentcar');
				break;
			case 'VRCCHOOSEDEPOSITPAYFULL':
				$result = __('Pay full amount now', 'vikrentcar');
				break;
			case 'VRCCHOOSEDEPOSITPAYDEPOF':
				$result = __('Leave a deposit of %s', 'vikrentcar');
				break;
			case 'VRCCUSTCHOICEPAYFULLADMIN':
				$result = __('Customer has chosen to pay the full amount.', 'vikrentcar');
				break;
